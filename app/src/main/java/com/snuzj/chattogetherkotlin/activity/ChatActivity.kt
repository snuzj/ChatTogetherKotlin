...
import com.snuzj.chattogetherkotlin.adapter.MessageAdapter
import com.snuzj.chattogetherkotlin.databinding.ActivityChatBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.imageView.setOnClickListener {
            if (binding.messageBox.text.isEmpty()){
                Toast.makeText(this,"Tin nhắn rỗng", Toast.LENGTH_SHORT).show()
            }
            else{
